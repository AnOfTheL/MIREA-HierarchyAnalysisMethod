...
namespace TPR_pr3
{
    public partial class Form1 : Form
    {
        ...
        public Form1(List<Criterion> criterionsFromElements, List<string> alternativesFromElements)
        {
            ...
            flag = new bool[criterionsList.Count + 1];
        ...
        private void scaleComboBox_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            if (elementComboBox.SelectedIndex == 0) { flag[0] = false; }
            else { flag[criterionsComboBox.SelectedIndex + 1] = false; }
        ...
        private void exploreButton_Click(object sender, EventArgs e)
        {
            ...
            if (elementComboBox.SelectedIndex == 0) { flag[0] = true; }
            else { flag[criterionsComboBox.SelectedIndex + 1] = true; }
        }

        private void resultButton_Click(object sender, EventArgs e)
        {
            foreach(bool value in flag)
            {
                if (!value)
                {
